...
pass:[--] EXTENSION https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPerformanceQuerySubmitInfoKHR.html[VkPerformanceQuerySubmitInfoKHR]: +
_counter_pass_index_: integer, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSubmitInfo.html[VkSubmitInfo])#

* [[submitinfo2]]
[small]#*submitinfo2* = { +
_flags_: <<submitflags, submitflags>>, +
_wait_semaphore_infos_: {<<semaphoresubmitinfo, semaphoresubmitinfo>>}, +
_command_buffer_infos_: {<<commandbuffersubmitinfo, commandbuffersubmitinfo>>}, +
_signal_semaphore_infos_: {<<semaphoresubmitinfo, semaphoresubmitinfo>>}, +
pass:[--] EXTENSION https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPerformanceQuerySubmitInfoKHR.html[VkPerformanceQuerySubmitInfoKHR]: +
_counter_pass_index_: integer, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSubmitInfo2KHR.html[VkSubmitInfo2KHR])#

* [[semaphoresubmitinfo]]
[small]#*semaphoresubmitinfo* = { +
_semaphore_: <<semaphore, semaphore>>, +
_value_: integer, +
_stage_mask_: <<pipelinestageflags, pipelinestageflags>>, +
_device_index_: integer, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSemaphoreSubmitInfoKHR.html[VkSemaphoreSubmitInfoKHR])#

* [[commandbuffersubmitinfo]]
[small]#*commandbuffersubmitinfo* = { +
_command_buffer_: <<command_buffer, command_buffer>>, +
_device_mask_: integer, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkCommandBufferSubmitInfoKHR.html[VkCommandBufferSubmitInfoKHR])#
...
pass:[--] EXTENSIONS: +
_rendering_info_: <<commandbufferinheritancerenderinginfo, commandbufferinheritancerenderinginfo>>, +
...
[small]#*commandbufferinheritancerenderinginfo* = { +
_flags_: <<renderingflags, renderingflags>>, +
_view_mask_: integer, +
_color_attachment_formats_: {<<format, format>>}, +
_depth_attachment_format_: <<format, format>>, +
_stencil_attachment_format_: <<format, format>>, +
_rasterization_samples_: <<samplecountflags, samplecountflags>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkCommandBufferInheritanceRenderingInfoKHR.html[VkCommandBufferInheritanceRenderingInfoKHR])#
...
pass:[--] EXTENSION https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkMemoryBarrier2KHR.html[VkMemoryBarrier2KHR]: +
_memory_barrier2_: <<memorybarrier2, memorybarrier2>>, +
...
_pipeline_statistics_: <<querypipelinestatisticflags, querypipelinestatisticflags>>, +
pass:[--] EXTENSIONS: +
_query_pool_performance_info_: <<querypoolperformancecreateinfo, querypoolperformancecreateinfo>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkQueryPoolCreateInfo.html[VkQueryPoolCreateInfo])#

* [[querypoolperformancecreateinfo]]
[small]#*querypoolperformancecreateinfo* = { +
_queue_family_index_: integer, +
_counter_indices_: {integer}, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkQueryPoolPerformanceCreateInfoKHR.html[VkQueryPoolPerformanceCreateInfoKHR])#

* [[performancecounter]]
[small]#*performancecounter* = { +
_unit_: <<performancecounterunit, performancecounterunit>>, +
_scope_: <<performancecounterscope, performancecounterscope>>, +
_storage_: <<performancecounterstorage, performancecounterstorage>>, +
_uuid_: binary string, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPerformanceCounterKHR.html[VkPerformanceCounterKHR])#

* [[performancecounterdescription]]
[small]#*performancecounterdescription* = { +
_flags_: <<performancecounterdescriptionflags, performancecounterdescriptionflags>>, +
_name_: string, +
_category_: string, +
_description_: string, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPerformanceCounterDescriptionKHR.html[VkPerformanceCounterDescriptionKHR])#

* [[acquireprofilinglockinfo]]
[small]#*acquireprofilinglockinfo* = { +
_flags_: <<acquireprofilinglockflags, acquireprofilinglockflags>>, +
_timeout_: integer, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkAcquireProfilingLockInfoKHR.html[VkAcquireProfilingLockInfoKHR])#
...
_rendering_state_: <<pipelinerenderingcreateinfo, pipelinerenderingcreateinfo>>, +
...
[small]#*pipelinerenderingcreateinfo* = { +
_view_mask_: integer, +
_color_attachments_: {<<renderingattachmentinfo, renderingattachmentinfo>>}, +
_depth_attachment_: <<renderingattachmentinfo, renderingattachmentinfo>>, +
_stencil_attachment_: <<renderingattachmentinfo, renderingattachmentinfo>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineRenderingCreateInfoKHR.html[VkPipelineRenderingCreateInfoKHR])#
...
_dependency_flags_: <<dependencyflags, dependencyflags>>, +
_memory_barriers_: {<<memorybarrier2, memorybarrier2>>}, +
_buffer_memory_barriers_: {<<buffermemorybarrier2, buffermemorybarrier2>>}, +
_image_memory_barriers_: {<<imagememorybarrier2, imagememorybarrier2>>}, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDependencyInfoKHR.html[VkDependencyInfoKHR])#
...
* [[memorybarrier2]]
[small]#*memorybarrier2* = { +
_src_stage_mask_: <<pipelinestageflags, pipelinestageflags>>, +
_dst_stage_mask_: <<pipelinestageflags, pipelinestageflags>>, +
_src_access_mask_: <<accessflags, accessflags>>, +
_dst_access_mask_: <<accessflags, accessflags>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkMemoryBarrier2KHR.html[VkMemoryBarrier2KHR])#
...
_offset_: integer, +
_size_: integer, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkBufferMemoryBarrier2KHR.html[VkBufferMemoryBarrier2KHR])#
...
_image_: <<image, image>>, +
_subresource_range_: <<imagesubresourcerange, imagesubresourcerange>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkImageMemoryBarrier2KHR.html[VkImageMemoryBarrier2KHR])#
...
_stencil_attachment_: <<renderingattachmentinfo, renderingattachmentinfo>>, +
pass:[--] EXTENSIONS: +
_fragment_shading_rate_: <<renderingfragmentshadingrateattachmentinfo, renderingfragmentshadingrateattachmentinfo>>, +
_fragment_density_map_: <<renderingfragmentdensitymapattachmentinfo, renderingfragmentdensitymapattachmentinfo>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkRenderingInfoKHR.html[VkRenderingInfoKHR])#

* [[renderingattachmentinfo]]
[small]#*renderingattachmentinfo* = { +
_image_view_: <<image_view, image_view>>, +
_image_layout_: <<imagelayout, imagelayout>>, +
_resolve_mode_: <<resolvemodeflags, resolvemodeflags>>, +
_resolve_image_view_: <<image_view, image_view>>, +
_resolve_image_layout_: <<imagelayout, imagelayout>>, +
_load_op_: <<attachmentloadop, attachmentloadop>>, +
_store_op_: <<attachmentstoreop, attachmentstoreop>>, +
_clear_value_: <<clearvalue, clearvalue>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkRenderingAttachmentInfoKHR.html[VkRenderingAttachmentInfoKHR])#

* [[renderingfragmentshadingrateattachmentinfo]]
[small]#*renderingfragmentshadingrateattachmentinfo* = { +
_image_view_: <<image_view, image_view>>, +
_image_layout_: <<imagelayout, imagelayout>>, +
_texel_size_: <<extent2d, extent2d>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkRenderingFragmentShadingRateAttachmentInfoKHR.html[VkRenderingFragmentShadingRateAttachmentInfoKHR])#

* [[renderingfragmentdensitymapattachmentinfo]]
[small]#*renderingfragmentdensitymapattachmentinfo* = { +
_image_view_: <<image_view, image_view>>, +
_image_layout_: <<imagelayout, imagelayout>>, +
} (rfr: https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkRenderingFragmentDensityMapAttachmentInfoEXT.html[VkRenderingFragmentDensityMapAttachmentInfoEXT])#
