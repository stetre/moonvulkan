...
* [[queue_family_index]]
[small]#*queue_family_index* = 0-based integer index.#

* [[queue_index]]
[small]#*queue_index* = 0-based integer index.#

NOTE: Indices that are used as identifiers in the Vulkan C API, like queue indices or queue family
indices, are 0-based also in MoonVulkan when used as function parameters or as fields of structs.
...
_queue_family_index_: <<queue_family_index, queue_family_index>>, +
...
_queue_family_indices_: {<<queue_family_index, queue_family_index>>}, +
...
_src_access_mask_: <<accessflags, accessflags>>, +
_dst_access_mask_: <<accessflags, accessflags>>, +
_src_queue_family_index_: <<queue_family_index, queue_family_index>> (default: ignored), +
_dst_queue_family_index_: <<queue_family_index, queue_family_index>> (default: ignored), +
_buffer_: <<buffer, buffer>> *[R]*, +
_offset_: integer, +
_size_: integer, +
