...
_current_extent_: <<extent2d, extent2d>> (may be _nil_, see note below), +
...
Note: The _current_extent_ field is not set when _width_ and _height_ have the special value 0xFFFFFFFF, meaning that the current extent is undefined.#
