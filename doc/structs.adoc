...
_color_blend_advanced_state_: <<pipelinecolorblendadvancedstatecreateinfo, pipelinecolorblendadvancedstatecreateinfo>> (Note1) _(DEPRECATED: will soon be moved within the color_blend_state field.)_, +
