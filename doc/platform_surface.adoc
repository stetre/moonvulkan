...
* _boolean_ = *get_physical_device_xlib_presentation_support*(_physdev_, _queue_family_index_, _display_, _visual_id_) +
...
* _boolean_ = *get_physical_device_xcb_presentation_support*(_physdev_, _queue_family_index_, _connection_, _visual_id_) +
...
* _boolean_ = *get_physical_device_wayland_presentation_support*(_physdev_, _queue_family_index_, _wldisplay_) +
...
* _boolean_ = *get_physical_device_mir_presentation_support*(_physdev_, _queue_family_index_, _mirconnection_) +
