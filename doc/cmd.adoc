...
arg6 - _dynamic_offsets_ : {integer} (opt.) +
...
[[cmd_blit_image]]
* *cmd_blit_image*(_cb_, _src_imagelayout, _..._) +
...
arg5 - _memory_barriers_: {<<memorybarrier, memorybarrier>>} (opt.) +
arg6 - _buffer_memory_barriers_: {<<buffermemorybarrier, buffermemorybarrier>>} (opt.) +
arg7 - _image_memory_barriers_: {<<imagememorybarrier, imagememorybarrier>>} (opt.) +
