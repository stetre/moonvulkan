...
[small]#arg3: [_per_swapchain_results_]: boolean +
arg4: [_display_present_info_]: <<displaypresentinfo, displaypresentinfo>> +
arg5: [_regions_]: <<presentregions, presentregions>> +
