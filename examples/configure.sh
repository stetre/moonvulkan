...
# $ . configure.sh
# or you may want to copy its contents in your bash profile.
#
# To make it work properly, you'll need to change the following two 
...
# Add the path to the validation layers json manifests to VK_LAYER_PATH.
...
#
# The layers.sh script can be used fot this purpose.
#
