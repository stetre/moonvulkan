...
local swapchain, swapchain_images, swapchain_format, swapchain_extent
do
...
-- Cleanup --------------------------------------------------------------------
-- From now on we'll omit the cleanup, since MoonVulkan will automatically do it
-- for us at exit (and also on error).
