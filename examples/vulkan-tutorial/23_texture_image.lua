...
local texture_image, texture_memory
do
   ...
   texture_image, texture_memory = create_image(w, h, 'r8g8b8a8 unorm', 'optimal',
            vk.IMAGE_USAGE_TRANSFER_DST_BIT | vk.IMAGE_USAGE_SAMPLED_BIT, 
            vk.MEMORY_PROPERTY_DEVICE_LOCAL_BIT)

   transition_image_layout(texture_image, 'r8g8b8a9 unorm', 'undefined', 'transfer dst optimal')
   copy_buffer_to_image(staging_buffer, texture_image, w, h)
   transition_image_layout(texture_image, 'r8g8b8a9 unorm', 'transfer dst optimal', 'shader read only optimal')
