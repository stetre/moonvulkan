...
local function create_image(w, h, mip_levels, format, tiling, usage, memflags)
...
do
   ...
   texture_image, texture_memory = create_image(w, h, texture_mip_levels, format, 'optimal',
...
local function create_swapchain(window, width, height)
   ...
   depth_image, depth_image_mem = create_image(
         swapchain_extent.width, swapchain_extent.height, 1, depth_format, 'optimal', 
